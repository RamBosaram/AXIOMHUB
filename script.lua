...
local Converted = {
	["_ZELKOVA"] = Instance.new("ScreenGui");
...
-- Alias: original code references both _ZELKOVA and _YARHM for the same ScreenGui
Converted["_YARHM"] = Converted["_ZELKOVA"]

-- Properties:

Converted["_ZELKOVA"].DisplayOrder = 3
Converted["_ZELKOVA"].IgnoreGuiInset = true
Converted["_ZELKOVA"].ScreenInsets = Enum.ScreenInsets.DeviceSafeInsets
Converted["_ZELKOVA"].ResetOnSpawn = false
Converted["_ZELKOVA"].ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Converted["_ZELKOVA"].Name = "YARHM"
Converted["_ZELKOVA"].Parent = game:GetService("CoreGui")

Converted["_Open"].Font = Enum.Font.Gotham
Converted["_Open"].Text = "Triple-click this region to open ZELKOVA."
...
Converted["_Open"].Parent = Converted["_ZELKOVA"]
...
Converted["_ListButton"].Parent = Converted["_ZELKOVA"]
...
Converted["_Notifications"].Parent = Converted["_ZELKOVA"]
...
Converted["_FloatingButton"].Parent = Converted["_ZELKOVA"]
...
Converted["_FloatingButtons"].Parent = Converted["_ZELKOVA"]
...
Converted["_AddCustomModule"].Parent = Converted["_ZELKOVA"]
...
Converted["_HubName"].Text = "ZELKOVA"
